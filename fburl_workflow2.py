...
dag = DAG('fburlworkflow_dag_v4', default_args=default_args, schedule_interval = '*/30 * * * *', user_defined_macros={"get_half_hour": get_half_hour, "get_s3key_location": get_s3key_location})
